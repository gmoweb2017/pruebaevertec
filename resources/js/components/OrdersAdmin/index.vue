<template>
  <div class="container">
        ...
        <div class="card" v-if="legacySystemHTML == ''">
          <div class="card-header">
            <div class="card-head-row card-tools-still-right">
              <h4 class="card-title">Listado de Orders</h4>
              <div class="card-tools">
                ...
                <button
                  ...
                  @click="
                    listarOrders(1, buscar, criterio, sortedColumn, order)
                  "
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-hover">
                ...
                <tbody>
                  <tr v-for="Order in arrayOrder" :key="Order.id">
                    <td v-text="Order.customer.customer_name"></td>
                    <td v-text="Order.value_order"></td>
                    <td>
    ...
    <!-- Formulario de Creacion y Edición de Orders -->
