<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue2">
				...
				<a href="index.html" class="logo">
					<img src="{{$logo}}" width="80%" alt="navbar brand" class="navbar-brand">
				</a>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<div class="dropdown-menu quick-actions quick-actions-info animated fadeIn">
								<div class="quick-actions-header">
									<span class="title mb-1">Enlaces rápidos</span>
									<span class="subtitle op-8">Accesos</span>
								</div>
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="../img/user4.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>{{ ucfirst(Auth::user()->name).' '.Auth::user()->surname }}</h4>
												<p class="text-muted">{{Auth::user()->email}}</p><a href="user4.html" class="btn btn-xs btn-secondary btn-sm">Ver Perfil</a>
											</div>
										</div>
									</li>
									<li>
